...
@RestController
// http://127.0.0.1.8080/reqeust-data/** 
...
public class RequestDataController {
  ...
  // @PathVariable(): requet의 url패턴에 따라 데이터를 추출하는 방법
  ...
  // path variable을 이용한 방법은 다른 메서드의 url패턴과 겹칠수 있음을 주의
  @GetMapping("/{variable}")
  ...
  // @RequestBody(): POST, PUT, PATCH, RequestBody로 전송한 데이터를 
  // 메소드에서 매개변수로 받기 위한 방법
